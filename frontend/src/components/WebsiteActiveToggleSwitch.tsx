...
export function WebsiteActiveToggleSwitch({
  websiteData,
}: {
  websiteData: Website;
}) {
  ...
  return (
    <div className="d-flex align-items-center">
      <Form.Check
        ...
        onChange={() => {
          ...
          const newWebsiteData = {
            id: websiteData.id,
            active: !websiteData.active,
          };
          const action = newWebsiteData.active ? "activate" : "deactivate";
          editWebsite(websiteData.id, newWebsiteData)
            .then(() => {
      ...
      ></Form.Check>
      <span
        className={state.updating ? "spinner-border spinner-border-sm" : ""}
      ></span>
